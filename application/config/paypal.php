 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'andrew_api1.esctt.com' : 'riskmp_api1.esctt.com';
$config['APIPassword'] = $config['Sandbox'] ? '1392392792' : '6QRJES8329KVBMFT';
$config['APISignature'] = $config['Sandbox'] ? 'AtWHlN2SpQ7c02xXFgS768y66cPnADWA6k.ONXPgF8qG-HuC8sTc4YvF' : 'AFcWxV21C7fd0v3bYYYRCpSSRl31A-TIp7S5GaOy7PjHtc.lX4xq9a3j';
 ...
 */
$config['PayFlowUsername'] = $config['Sandbox'] ? 'tester' : 'PRODUCTION_USERNAME_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = $config['Sandbox'] ? 'andrew@angelleye.com' : 'andrew@esctt.com';
