...
//        }
    ...
    function Do_direct_payment() {
        ...
        $CCDetails = array(
            ...
            'acct' => 4872257184345422, // Required.  Credit card number.  No spaces or punctuation.  
        ...
        $BillingAddress = array(
            'street' => '276 Alex Doner Drive', // Required.  First street address.
            'street2' => '', // Second street address.
            'city' => 'Newmarket', // Required.  Name of City.
            'state' => 'ON', // Required. Name of State or Province.
            'countrycode' => 'CA', // Required.  Country code.
            'zip' => 'L4G2Z9', // Required.  Postal code of payer.
            'phonenum' => '9058306950'       // Phone Number of payer.  20 char max.
        );
        ...
        $PaymentDetails = array(
            'amt' => 101.05, // Required.  Total amount of order, including shipping, handling, and tax.  
    ...
    function Create_recurring_payments_profile() {
        ...
        $ProfileDetails = array(
            'subscribername' => "Test Testerson", // Full name of the person receiving the product or service paid for by the recurring payment.  32 char max.
            'profilestartdate' => date("Y-m-d", strtotime("+1 month")) . "T00:00:00\Z", // Required.  The date when the billing for this profiile begins.  Must be a valid date in UTC/GMT format.
        ...
        $BillingPeriod = array(
            ...
            'amt' => 115.79, // Required.  Billing amount for each billing cycle during the payment period.  This does not include shipping and tax. 
        ...
        $ActivationDetails = array(
            'initamt' => 115.79, // Initial non-recurring payment amount due immediatly upon profile creation.  Use an initial amount for enrolment or set-up fees.
            ...
            'notifyurl' => 'http://v1.riskmp.com/user/dump'
        );
        ...
        $PayerInfo = array(
            'email' => "buyer@esctt.com", // Email address of payer.
            'payerid' => '', // Unique PayPal customer ID for payer.
            'payerstatus' => '', // Status of payer.  Values are verified or unverified
            'business' => ''        // Payer's business name.
        );
        ...
        $PayerName = array(
            'salutation' => '', // Payer's salutation.  20 char max.
            'firstname' => "Test", // Payer's first name.  25 char max.
            'middlename' => '', // Payer's middle name.  25 char max.
            'lastname' => "Testerson", // Payer's last name.  25 char max.
            'suffix' => ''        // Payer's suffix.  12 char max.
        );
        ...
        $BillingAddress = array (
            ...
            'street2' => '', // Second street address.
            'city' => 'Newmarket', // Required.  Name of City.
            'state' => 'Ontario', // Required. Name of State or Province.
            'countrycode' => 'CA', // Required.  Country code.
            'zip' => 'L4G2Z9', // Required.  Postal code of payer.
            'phonenum' => '9058306950'      // Phone Number of payer.  20 char max.
        );
...
//        }
    ...
    function Manage_recurring_payments_profile_status($profile_id) {
        $MRPPSFields = array(
            'profileid' => $profile_id, // Required. Recurring payments profile ID returned from CreateRecurring...
    ...
    function Update_recurring_payments_profile() {
        $URPPFields = array(
            'profileid' => 'I-19NGTCYGUWB0', // Required.  Recurring payments ID.
            'amt' => 2000.00, // Billing amount for each cycle in the subscription, not including shipping and tax.  Express Checkout profiles can only be updated by 20% every 180 days.
        );
